...
class SessionMinDurationTest {
    @Test
    public void shouldReturnMinDuration50Minutes() {
        ...
        Assertions.assertEquals(minDuration, new SessionMinDuration("").apply(sleepingSessions).getResult());
    }
